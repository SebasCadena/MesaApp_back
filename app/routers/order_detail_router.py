...
def list_order_details(db: Session = Depends(get_db)) -> list[OrderDetail]:
...
def create_order_detail(payload: OrderDetailCreate, db: Session = Depends(get_db)) -> OrderDetail:
